...
class BaseFolderPopup(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        raw_header = QtWidgets.QLabel('<b>Raw Data Folder</b>')
        ...
        probe_header = QtWidgets.QLabel('<b>Probe Configuration Folder </b>')
        ...
        probefile_header = QtWidgets.QLabel('<b>Default Probe File</b>')
        ...
        paramfile_header = QtWidgets.QLabel('<b>Parameter File</b>')
